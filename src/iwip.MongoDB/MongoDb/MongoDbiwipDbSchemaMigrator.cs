...
public class MongoDbiwipDbSchemaMigrator : IiwipDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbiwipDbSchemaMigrator(IServiceProvider serviceProvider)
    {
