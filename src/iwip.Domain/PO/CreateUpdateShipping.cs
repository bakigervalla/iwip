...
namespace iwip.PO
{
    public class CreateUpdateShipping : BasicAggregateRoot<Guid>, IMultiTenant
    {
        public CreateUpdateShipping()
        {
        ...
        public List<ShippingDocument> SHIPPING_DOCUMENTS { get; set; }
    }
}
